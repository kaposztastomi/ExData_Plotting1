...
datapoint$DateTime <- as.POSIXct(paste(datapoint$Date, 
                                   datapoint$Time), format="%Y-%m-%d %H:%M:%S")


plot(datapoint$DateTime, datapoint$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
